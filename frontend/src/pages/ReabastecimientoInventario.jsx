...
function ReabastecimientoInventario() {
  ...
  return (
    <div className="reabasto-container">
      <NavBar role="Encargado" />

      <main className="reabasto-content">
        <header className="reabasto-header">
          <div className="reabasto-header-icon">
          ...
          <div>
            <h1 className="reabasto-title">Reabastecimiento de Inventario</h1>
            <p className="reabasto-subtitle">Registrar entrada de nuevos lotes de productos</p>
          </div>
        </header>
